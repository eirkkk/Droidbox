...
```bash
echo 'nameserver 1.1.1.1' >> /etc/resolv.conf &&apt update && apt install wget -y && wget https://raw.githubusercontent.com/eirkkk/Droidbox/main/box.sh && bash box.sh && rm box.sh
```
