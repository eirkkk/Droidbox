...
apt install -y libc6:armhf gpg libasound-dev:armhf && rm -rf /var/lib/dpkg/info/* && apt install systemd:armhf libpulse-dev:armhf libgnutls*:arm64 libgnutls*:armhf zenity libopenvr-dev:armhf wget git  mesa-utils:arm64 xz-utils pulseaudio vk* vulkan-tools libarchive-dev libarchive-dev:armhf gpg
