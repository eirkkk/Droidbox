...
wget https://github.com/Kron4ek/Wine-Builds/releases/download/proton-8.0-3/wine-proton-8.0-3-amd64.tar.xz > /dev/null 2>&1
...
wget https://github.com/eirkkk/Droidbox/releases/download/Eirkkk/VulkanDriveBox.tar.xz > /dev/null 2>&1
...
apt remove mesa-vulkan-drivers:armhf -y > /dev/null 2>&1
apt remove mesa-vulkan-drivers:arm64 -y > /dev/null 2>&1

cd ~/
wget https://raw.githubusercontent.com/Winetricks/winetricks/master/src/winetricks > /dev/null 2>&1
chmod +x winetricks
mv winetricks /usr/local/bin/
wget https://raw.githubusercontent.com/eirkkk/Droidbox/main/mesa-vulkan-kgsl_23.2.1-20231004_arm64.deb > /dev/null 2>&1
wget https://raw.githubusercontent.com/eirkkk/Droidbox/main/mesa-vulkan-kgsl_23.2.1-20231004_armhf.deb > /dev/null 2>&1
dpkg -i mesa-vulkan-kgsl*arm64.deb  > /dev/null 2>&1
dpkg -i mesa-vulkan-kgsl*armhf.deb > /dev/null 2>&1
